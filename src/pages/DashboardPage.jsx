        ...
        <div className="h-full flex flex-col">
            ...
            <div className="flex-grow grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 pt-0 overflow-hidden">
                <aside className="lg:col-span-1 h-full overflow-hidden">
                    {loading ? (
                        <div className="w-full h-full flex items-center justify-center bg-tremor-background dark:bg-dark-tremor-background rounded-tremor-default p-4">
                ...
                <main className="lg:col-span-2 h-full rounded-tremor-default overflow-hidden">
                    { !VITE_MAPBOX_TOKEN ? (
